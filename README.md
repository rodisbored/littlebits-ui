...
Import required React Bootstrap components within ```src/InventionList.js``` file or your custom component files:
...
4. Add `// @flow` to any files you want to type check (for example, to `src/InventionList.js`).
...
This test mounts a component and makes sure that it didn’t throw during rendering. Tests like this provide a lot value with very little effort so they are great as a starting point, and this is the test you will find in `src/InventionList.test.js`.
